describe('e-conomic get customers trigger', function () {
    ...
    it('should emit new msg on success request', function () {
        ...
        nock('https://restapi.e-conomic.com')
            .get('/customers?filter=lastUpdated$gt:' + snapshot.lastChecked + '&pagesize=999')
        ...
        runs(function(){
            ...
            expect(calls[0].args[1].body).toEqual({items: allCustomersOutJSON});
